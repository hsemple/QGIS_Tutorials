...
Loading Ddifferent Types of Spatial Data into QGIS
==================================================
...
With desktop GIS, we can load the spatial data types mentioned above into the software in their original format. With web–based GIS platforms, the data types must be converted to web-based formats. ArcGIS Online can handle a surprisingly large number of spatial data formats. 
